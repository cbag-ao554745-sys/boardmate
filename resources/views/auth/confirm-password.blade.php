...
<head>
    ...
    <title>Confirm Password - Upahan</title>
...
<body
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-lg shadow-xl p-8">
            <h2 class="text-2xl font-bold text-slate-900 mb-2">Confirm Password</h2>
            <p class="text-slate-600 text-sm mb-6">For security, please confirm your password before continuing.</p>
