<x-layout title="Create Payment Method">
    <div>
        <div class="mb-8 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-foreground text-3xl font-bold">Create Payment Method</h1>
                <p class="text-muted-foreground mt-1 text-sm">Add a new payment method to the system</p>
            </div>
        </div>
